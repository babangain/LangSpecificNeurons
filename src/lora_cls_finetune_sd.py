...
class LoRAFineTuner:
    ...
    def _get_frozen_neurons(self) -> torch.tensor:
        lang_neuron_path = Path(Path.cwd(), f"outputs/lang_neurons/{self.model_name.split('/')[-1]}/{self.lang_set}/lang_neuron_data.pkl")
...
def main(model_name: str, device: torch.device) -> None:
    config = {
        ...
        "lang_set": "set6", "lang": "en", "finetune_lang": "en+ur", # ["en", "vi", "en+vi", "null"]
