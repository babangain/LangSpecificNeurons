import torch, os, sys, tqdm, pickle, datetime
...
class GenericLangNeuron:
    ...
    def _init_attr(self):
        self.lang_list = lang_map["set1"] + ["hi", "ur"] # lang_map["set1"]
    ...
    def _get_lang_to_neuron_map(self) -> dict:
        ...
        for lang, rel in self.rel_dict.items():
    ...
    def get_lang_specific_neurons_dist(self, is_plot: bool) -> dict:
        ...
        if is_plot:
            ...
            title = f'{self.model_name_srt}: Language Specific Neurons Distribution'
    ...
    def get_layerwise_neurons_dist(self, is_plot: bool) -> dict:
        ...
        if is_plot:
            ...
            title = f'{self.model_name_srt}: Layerwise Neurons Distribution'
    ...
    def get_neurons_overlap(self, is_plot: bool) -> dict:
        ...
        if is_plot:
            ...
            title = f'{self.model_name_srt}: Neurons Overlap Between Languages'
    ...
    def plot_3_lang_overlap_venn(self, languages: List[str]) -> None:
        ...
        title = f'{self.model_name_srt}: Neurons Overlap Between Languages ({languages})'
...
def main(model_name: str, device: torch.device) -> None:
    ...
    lang_neuron = GenericLangNeuron(device=device, model_name=model_name, scoring_method=methods[0])
