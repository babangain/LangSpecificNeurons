...
def main(model_name: str, device: torch.device) -> None:
    ...
    rel = NeuronRelevanceByContrastingActivation(device=device, model_name=model_name, quant_config=None, lang_list=["en", "vi"], num_iterations=1000)
