...
CONFIG_PATHS=(
    "/raid/speech/soumen/MS_Research/LangSpecificNeurons/outputs/ckpt/Meta-Llama-3.1-8B_finetune_XNLI/data_ur_frozen__0.25_1.0e-05_r8/master_config.pkl"
)

CKPT_NAMES=(
    "checkpoint-12192/pytorch_model.bin"
)
...
for i in "${!CONFIG_PATHS[@]}"; do
    ...
    nohup python src/task_eval.py > task_eval_ur_ur_${i}.out & 
done
